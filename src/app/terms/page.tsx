            ...
            <article className="prose prose-invert prose-lg max-w-none">
                ...
                <section className="mb-8">
                    ...
                    <p>
                        ...
                        triggers. <br />
                        The App is not intended for emergency, medical, or safety-critical use.
                        Do not rely on it for time-sensitive or life-critical situations.
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <ul className="space-y-2 list-disc list-inside">
                        ...
                        <li>Do not use the App to harass, spam, or track others without consent.
                        </li>
                    </ul>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <p className="mb-4">The App may request Android permissions to provide core
                        features:</p>
                    <div className="space-y-4">
                        <div className="bg-white/5 rounded-lg p-4 sm:p-6">
                            <p>
                                <strong
                                    className="text-neuracue-link">Location</strong> (approximate/precise;
                                foreground and
                        ...
                        <div className="bg-white/5 rounded-lg p-4 sm:p-6">
                            <p>
                                <strong className="text-neuracue-link">Notifications</strong> to
                                alert you when reminders trigger.
                            </p>
                        </div>
                    </div>
                    <p className="mt-4">
                ...
                <section className="mb-8">
                    ...
                    <p>
                        ...
                        connectivity, and platform services outside our control. <br />
                        Notifications may be delayed or not delivered due to device settings,
                        battery optimizations, connectivity, or operating system restrictions.
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <ul className="space-y-2 list-disc list-inside">
                        ...
                        <li>
                            <strong>Freemium:</strong> App is currently provided free of charge.
                            We may introduce optional paid features in the future, which will be
