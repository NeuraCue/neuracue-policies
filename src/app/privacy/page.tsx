            ...
            <article className="prose prose-invert prose-lg max-w-none">
                ...
                <section className="mb-8">
                    ...
                    <div className="space-y-4">
                        <div className="bg-white/5 rounded-lg p-4 sm:p-6">
                            <p className="mb-2">
                                <strong className="text-neuracue-link">Location data (optional,
                                    permission-based)</strong>
                            </p>
                            <p className="text-sm sm:text-base">
                                ...
                                time. <br />
                                <em>Background:</em> location access is used only to trigger
                                reminders reliably when you arrive at or leave a place, even when
                                the app is not actively open.
                            </p>
                        </div>
                        <div className="bg-white/5 rounded-lg p-4 sm:p-6">
                            <p>
                                <strong className="text-neuracue-link">Device &amp; app
                                    info</strong> (OS version, app
                        ...
                        <div className="bg-white/5 rounded-lg p-4 sm:p-6">
                            <p>
                                <strong className="text-neuracue-link">Crash reports</strong> (e.g.,
                                stack traces, device state at
                                crash) to fix stability issues.
                            </p>
                        </div>
                        <div className="bg-white/5 rounded-lg p-4 sm:p-6">
                            <p>
                                <strong className="text-neuracue-link">Contact data you
                                    provide</strong> when you email us (email
                ...
                <section className="mb-8">
                    ...
                    <ul className="space-y-2 list-disc list-inside">
                        ...
                        <li>
                            Analytics and crash reporting may be provided by services such as Google
                ...
                <section className="mb-8">
                    ...
                    <p>
                        ...
                        to protect personal data against unauthorized access, loss, misuse, or
                ...
                <section className="mb-8">
                    ...
                    <div className="space-y-4">
                        <div className="bg-white/5 rounded-lg p-4 sm:p-6">
                            <p>
                                <strong className="text-neuracue-link">Permissions:</strong> Grant
                                or revoke Location
                        ...
                        <div className="bg-white/5 rounded-lg p-4 sm:p-6">
                            <p>
                                <strong className="text-neuracue-link">Data deletion:</strong> You
                                can request deletion of support
                        ...
                        <div className="bg-white/5 rounded-lg p-4 sm:p-6">
                            <p>
                                <strong className="text-neuracue-link">Opt-out of
                                    analytics:</strong> Contact us to request opt-out
